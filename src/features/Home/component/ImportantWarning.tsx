    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="mx-auto container px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white rounded-[40px] p-8 md:p-16 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] border border-gray-100 flex flex-col lg:flex-row items-center gap-12 lg:gap-20"
        >
          {/* Left Side: Content */}
          <div className="flex-1 w-full">
            {/* Warning Badge */}
            <div className="inline-flex items-center gap-2 bg-[#FFF1F1] text-[#EF4444] px-4 py-2 rounded-full mb-8 border border-[#FEE2E2]">
            ...
            <p className="text-[#64748B] text-lg leading-relaxed mb-10 max-w-xl">
          ...
          <div className="flex-1 w-full max-w-md">
            <motion.div
              ...
              className="bg-white rounded-3xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-gray-50"
            >
              ...
              <div className="space-y-4">
                {/* Blacklist Status */}
                <div className="bg-[#FFF1F1] p-4 rounded-2xl flex items-center justify-between border border-[#FEE2E2]">
                ...
                {/* Warranty */}
                <div className="bg-[#F0FDF4] p-4 rounded-2xl flex items-center justify-between border border-[#DCFCE7]">
                  <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[#22C55E]" />
                    <span className="font-bold text-[#1E293B]">Warranty</span>
                  </div>
